<template>
  <div class="suifang app-container">
    ...
    <el-form ref="form" :model="form" label-width="87px" class="changesize">
      <el-row>
        ...
        <el-col :md="10" :sm="24" :xs="24">
          <el-form-item label="记录类型:">
            <el-col :span="12">
              <el-select :disabled="true" v-model="newDoctor.inquiryType" placeholder="请选择" style="width:100%">
                <el-option
        ...
        <el-col :offset="2" :md="10" :sm="24" :xs="24">
          <el-form-item label="接诊医生:">
            <el-col :span="12">
              ...
              <el-input :disabled="true" v-model="newDoctor.bsPrescription.doctorName" placeholder="请输姓名"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
        <el-col :md="10" :sm="24" :xs="24">
          <el-form-item label="就诊科室:">
            <el-col :span="12">
              <el-input :disabled="true" placeholder="请输入就诊科室" v-model="newDoctor.bsPrescription.departementName"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :md="10" :sm="24" :xs="24">
          <el-form-item label="档案编号:">
            <el-col :span="12">
              <el-input :disabled="true" type="text" placeholder="请输入档案编号" v-model="newDoctor.archivesNumber"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :offset="2" :md="10" :sm="24" :xs="24">
          <el-form-item label="年龄:">
            <el-col :span="12">
              <el-input :disabled="true" type="text" v-model="newDoctor.patientAge"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
        <el-col :md="10" :sm="24" :xs="24">
          <el-form-item label="性别:">
            <el-radio-group :disabled="true" v-model="newDoctor.patientSex">
      ...
      <el-row>
        <el-col :offset="2" :span="12" :md="10" :sm="24" :xs="24">
          <el-form-item label="身份证号:">
            <el-col :span="12">
              <el-input type="text" :disabled="true" v-model="newDoctor.patientCode" placeholder="请输入身份证号"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :offset="2" :md="16" :sm="24" :xs="24">
          <el-form-item label="诊断:">
            <el-col :span="24">
              <el-input type="text" :disabled="true" v-model="newDoctor.diagnosis"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :offset="2" :md="16" :sm="24" :xs="24">
          <el-form-item label="电子处方:">
            <el-col :span="24">
              <el-button size="mini" @click="addPrescription">查看处方</el-button>
            </el-col>
          </el-form-item>
        </el-col>
      </el-row>
        ...
        <el-row class="PrescriptionHead" id="electronicPrescription">
          <el-col :md="16" :sm="16" :xs="16" class="electronicPrescription">
            ...
            <div class="baseData">
              ...
              <div>
                <span>性别:</span>
                <el-input type="text" disabled class="inputstle" v-model="Sex"></el-input>
              </div>
              <div>
                <span>年龄:</span>
                <el-input
              ...
              >
                ...
                <el-row class="counter">
                  ...
                  <el-col :md="6" :sm="6" :xs="6" class="Medication_compliance">
                    <span>
                      每次
                      <el-input size="mini" disabled v-model="item.dosageMini"></el-input>
                    </span>
                  </el-col>
                </el-row>
                <el-row style="line-height:42px">
                  <el-col :md="12" :sm="6" :xs="6" class="Medication_compliance">
                    <span>
                      用法
                      <el-input size="mini" disabled placeholder="口服" v-model="item.drugsUsage"></el-input>
                    </span>
                  </el-col>
                </el-row>
              </div>
          ...
          <el-col :md="8" :sm="8" :xs="8" class="choiceDrug" id="add">
            ...
            >
              ...
              <div class="font_size text_align_right">
                <el-button size="mini" disabled @click="addDrugToLeft(i)" style="margin-bottom:5px ;width: 80px;">添加</el-button>
