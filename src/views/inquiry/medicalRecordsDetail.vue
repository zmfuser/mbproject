      ...
      <el-row>
        <el-col :offset="2" :md="10" :sm="24" :xs="24">
          <el-form-item label="年龄:" prop="patientAge">
            <el-col :span="12">
              <el-input type="number" min="1" max="160" placeholder="请输入数字" v-model="newDoctor.patientAge"></el-input>
            </el-col>
          </el-form-item>
        </el-col>
        <el-col :md="10" :sm="24" :xs="24" >
          ...
          <el-col :md="8" :sm="8" :xs="8" class="choiceDrug" id="add">
            ...
            >
              ...
              <div class="font_size text_align_right">
                ...
                >添加</el-button>
                <el-button size="mini" type="success" class="instructions" @click="checkInstructions(i)">查看说明</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
