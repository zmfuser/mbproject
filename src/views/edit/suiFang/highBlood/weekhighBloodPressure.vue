              ...
              <el-form-item label="症状">
                ...
                <div v-if="symptom1==2">
                  <el-checkbox-group v-model="symptom" @change="checkboxChange(symptom,1)">
                    <el-checkbox label="3" >恶心</el-checkbox>
                    <el-checkbox label="4" >呕吐</el-checkbox>
                    <el-checkbox label="5" >鼻出血</el-checkbox>
                    <el-checkbox label="6" >头疼</el-checkbox>
                    <el-checkbox label="7" >头晕</el-checkbox>
                    <el-checkbox label="8" >视物模糊</el-checkbox>
                  </el-checkbox-group>
                </div>
              </el-form-item>
            </el-col>
...
export default {
  ...
  created() {},
  mounted() {
    this.$set(this,'form',this.gaoWeek)
    this.chansformbox()
  },
  methods: {
    // 添加单选框字段到复选里
    addToSympom(val) {
      ...
      for (const index in _this.symptom) {
        if (_this.symptom[index] == 1 || _this.symptom[index] == 2) {
