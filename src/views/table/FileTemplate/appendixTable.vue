<template>
  <div class="base">
    ...
    <el-form  class="padd form" :model="form" label-position="top">
      <el-row>
        <el-col>
          <el-form-item label="1、近一个月的血压情况(高血压病)">
            <el-radio-group v-model="form.bloodPressure">
      ...
      <div>
        <el-row>
          <el-form-item label="2.近48小时的胸痛情况（冠心病）">
            <el-radio-group v-model="form.chestPain">
          ...
          <el-row>
            <el-col :md="12" :sm="12" :xs="24">
              <el-form-item label="胸痛发作次数：">
                <el-radio-group v-model="form.chestPainQuit">
            ...
            <el-col :md="12" :sm="12" :xs="24">
              <el-form-item label="胸痛伴随症状：">
                <el-checkbox-group
                  v-model="chestPainSymptom"
                  @change="checkboxChange(chestPainSymptom,1)"
                >
                  <el-checkbox label="1" >心慌</el-checkbox>
                  <el-checkbox label="2" >出汗</el-checkbox>
                  <el-checkbox label="3" >濒死感</el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
            ...
            <el-col :md="24" :sm="24" :xs="24">
              <el-form-item label="胸痛持续时间：">
                <el-radio-group v-model="form.chestPainTime">
                ...
                <el-row>
                  <el-col :md="12" :sm="12" :xs="24">
                    <el-form-item label="运动">
                      <el-checkbox-group
                        v-model="chestPainIncentive"
                        @change="checkboxChange(chestPainIncentive,2)"
                      >
                  ...
                  <el-col :md="12" :sm="12" :xs="24">
                    <el-form-item label="静息">
                      <el-radio-group
                        v-model="dayAnight"
                        @change="dayornight(dayAnight)"
                      >
                        <el-radio label="7" name="type">白天</el-radio>
                        <el-radio label="8" name="type">夜间</el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                </el-row>
      ...
      <el-row>
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item label="3、低血糖发作情况(糖尿病)">
            <el-radio-group v-model="showOrDiabetes" @change="pushToDiabetes(showOrDiabetes)">
      ...
      <div v-if="showOrDiabetes!=0">
        <el-row>
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item>
              <el-radio-group v-model="diabetesRadio" @change="radiopushToDiabetes(diabetesRadio)">
          ...
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item>
              <el-checkbox-group v-model="diabetes" @change="checkboxChange(diabetes,3)">
        ...
        <el-form-item>
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item label="高血压病：">
              <el-checkbox-group
                v-model="hypertensionComplicated"
                @change="checkboxChange(hypertensionComplicated,4)"
              >
          ...
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item label="冠心病：">
              <el-checkbox-group
                v-model="coronaryHeartComplicated"
                @change="checkboxChange(coronaryHeartComplicated,5)"
              >
          ...
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item label="糖尿病：">
              <el-checkbox-group
                v-model="diabetesComplicated"
                @change="checkboxChange(diabetesComplicated,6)"
              >
      ...
      <el-row>
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item label="5、现存危险因素">
            <el-checkbox-group v-model="riskFactor" @change="checkboxChange(riskFactor,7)">
      ...
      <el-row>
        <el-col :md="24" :sm="24" :xs="24">
          <el-form-item label="6、伴发疾病">
            <el-checkbox-group v-model="accomDisease" @change="checkboxChange(accomDisease,8)">
              ...
              <template>
                ...
                >
                  ...
                  <el-table-column prop="drugSideEffects" label="药物副作用" align="center">
                    <template slot-scope="scope">
                      <el-input
                        v-model="scope.row.drugSideEffects"
                        type="textarea"
                        size="mini"
                  ...
                  <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                      <img
                        ...
                        alt
                        @click="addrow(form.bsArchivesDoses,{ historyType: 0, dataType: 1 })"
                      >
                      <img
        ...
        <el-form-item label="8、辅助检查(近一年最近一次资料)">
          <el-col :md="12" :sm="12" :xs="24">
            <el-form-item label="血常规">
              ...
              <div style="margin-top: 15px;">
                <el-input placeholder="请输入内容" v-model="form.leukocyte">
              ...
              <!-- <div style="margin-top: 15px;">
                <el-input placeholder="请输入内容" v-model="form.input4">
          ...
          <el-col :md="12" :sm="12" :xs="24">
            <el-form-item label="尿常规">
              <div>
                <el-input placeholder="请输入内容" v-model="form.urineProtein">
                  <template slot="prepend">尿蛋白</template>
                </el-input>
              </div>
              <div style="margin-top: 15px;">
                <el-input placeholder="请输入内容" v-model="form.urineSugar">
                  <template slot="prepend">尿糖</template>
                </el-input>
              </div>
              <div style="margin-top: 15px;">
                <el-input placeholder="请输入内容" v-model="form.ketoneBodies">
                  <template slot="prepend">尿酮体</template>
                </el-input>
              </div>
              <div style="margin-top: 15px;">
                <el-input placeholder="请输入内容" v-model="form.bid">
      ...
      <el-row :gutter="20">
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="尿微量白蛋白">
            <div>
              <el-input placeholder="请输入内容" v-model="form.urinaryMicroalbumin">
        ...
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="血尿酸">
            <div>
              <el-input placeholder="请输入内容" v-model="form.homocysteine">
      ...
      <el-row :gutter="20">
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="空腹血糖">
            <div>
              <el-input placeholder="请输入内容" v-model="form.eatBloodSugar">
                <template slot="prepend">餐后2小时血糖</template>
                <template slot="append">mmol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.glycosyHemoglobin">
        ...
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="肾功能">
            <div>
              <el-input placeholder="请输入内容" v-model="form.scr">
                <template slot="prepend">血清肌酐</template>
                <template slot="append">umol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.bun">
      ...
      <el-row :gutter="20">
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="肝功能">
            <div>
              <el-input placeholder="请输入内容" v-model="form.serumAst">
                <template slot="prepend">血清谷丙转氨酶</template>
                <template slot="append">u/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.serumAmino">
                <template slot="prepend">血清谷草转氨酶</template>
                <template slot="append">u/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.albumin">
                <template slot="prepend">白蛋白</template>
                <template slot="append">g/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.bilirubin">
                <template slot="prepend">总胆红素</template>
                <template slot="append">umol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.bindingBilirubin">
        ...
        <el-col :md="12" :sm="12" :xs="24">
          <el-form-item label="血脂">
            <div>
              <el-input placeholder="请输入内容" v-model="form.cholesterol">
                <template slot="prepend">总胆固醇</template>
                <template slot="append">mmol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.triglyceride">
                <template slot="prepend">甘油三酯</template>
                <template slot="append">mmol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.cholesterolLdl">
                <template slot="prepend">低密度脂蛋白胆固醇</template>
                <template slot="append">mmol/l</template>
              </el-input>
            </div>
            <div style="margin-top: 15px;">
              <el-input placeholder="请输入内容" v-model="form.cholesterolHdl">
      ...
      <el-row class="inputNborder">
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item >
            <label>心电图：</label>
            <el-radio-group v-model="form.electrocardiogram">
              <el-radio label="0">正常</el-radio>
              <el-radio label="1">异常</el-radio>
            </el-radio-group>
            <span style="padding-left:8px" v-if="form.electrocardiogram == 1">
              异常描述:
              <el-input class="miniWBIG" v-model="form.electrocardiogramDesc" ></el-input>
            </span>
          </el-form-item>
        </el-col>
        ...
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item>
            ...
            <el-radio-group v-model="form.carotidArter">
              <el-radio label="0">正常</el-radio>
              <el-radio label="1">异常</el-radio>
            </el-radio-group>
            <span style="padding-left:8px" v-if="form.carotidArter == 1">
              异常描述:
              <el-input class="miniWBIG" v-model="form.carotidArterDesc" ></el-input>
            </span>
          </el-form-item>
        </el-col>
        ...
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item>
            ...
            <el-radio-group v-model="form.fundusExamination">
              <el-radio label="0">正常</el-radio>
              <el-radio label="1">异常</el-radio>
            </el-radio-group>
            <span style="padding-left:8px" v-if="form.fundusExamination == 1">
              异常描述:
              <el-input class="miniWBIG" v-model="form.fundusExaminationDesc" ></el-input>
            </span>
          </el-form-item>
        </el-col>
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item>
            ...
            <el-radio-group v-model="form.uitrasound">
              <el-radio label="0">正常</el-radio>
              <el-radio label="1">异常</el-radio>
            </el-radio-group>
            <span style="padding-left:8px" v-if="form.uitrasound == 1">
              异常描述:
               <el-input class="miniWBIG" v-model="form.uitrasoundDesc" ></el-input>
            </span>
          </el-form-item>
        </el-col>
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item>
            ...
            <el-radio-group v-model="form.cag">
              <el-radio label="0">正常</el-radio>
              <el-radio label="1">异常</el-radio>
            </el-radio-group>
            <span style="padding-left:8px" v-if="form.cag == 1">
              异常描述:
              <el-input class="miniWBIG" v-model="form.cagDesc"></el-input>
            </span>
          </el-form-item>
        </el-col>
        <el-col :md="24" :sm="12" :xs="24">
          <el-form-item>
            ...
            <span  style="padding-left:8px">
              异常描述:
              <el-input class="miniWBIG" v-model="form.other"></el-input>
            </span>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :md="24" :sm="24" :xs="24">
          <el-form-item label="手术史：" prop="servin">
            <el-radio-group
              v-model="form.scheduleOperation"
            >
              <el-radio label="1">无</el-radio>
              <el-radio label="0">有</el-radio>
            </el-radio-group>
            <div v-if="form.scheduleOperation == 0">
              <template>
                <el-table
                  border
                  :data="form.bsArchivesPastHistories"
                  style="width: 100%"
                  :header-cell-style="{background:tableHead}"
                >
                  <el-table-column prop="historyName" label="手术名称" style="width:6vw;" align="center">
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="historyDate" label="手术时间" align="center">
                    <template slot-scope="scope">
                      <!-- <el-input v-model="scope.row.opstiem"></el-input> -->
                      <div class="block">
                         <el-date-picker v-model="scope.row.historyDate" type="date" placeholder="选择日期"></el-date-picker>
                       </div>
                    </template>
                  </el-table-column>
                  <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                      <img
                        src="../../../../static/png/add.png"
                        alt
                        @click="addrow(form.bsArchivesPastHistories,{ historyType: 0, dataType: 2 })"
                      >
                      <img
                        src="../../../../static/png/del.png"
                        alt
                        @click.prevent="delrow(scope.$index, form.bsArchivesPastHistories)"
                      >
                    </template>
                  </el-table-column>
                </el-table>
                  ...
                  <el-table-column fixed="right" label="操作" align="center">
                    <template slot-scope="scope">
                      <img
                        src="../../../../static/png/add.png"
                        alt
                        @click="addrow(form.bsArchivesInHospitals,{ historyType: 0, dataType: 1 })"
                      >
                      <img
                        src="../../../../static/png/del.png"
                        alt
...
export default {
  data() {
    return {
      ...
      form: {
        ...
        cag: "0",
        other: "",
        electrocardiogramDesc: "",
        chestXrayDesc: "",
        carotidArterDesc: "",
        fundusExaminationDesc: "",
        uitrasoundDesc: "",
        cagDesc: "",
        textarea7: "",
        // 手术史
        scheduleOperation: "1",
        // 手术史
        bsArchivesPastHistories:[{ historyType: 0, dataType: 1 }],
        // 服药情况
        bsArchivesDoses: [{ historyType: 0, dataType: 1 }],
        // 住院史
        bsArchivesInHospitals: [{ historyType: 0, dataType: 1 }]
      },
      options: [
        { value: "1", label: "规律" },
        { value: "2", label: "间断" },
  ...
  methods: {
    ...
    // 低血糖发作情况
    radiopushToDiabetes(diabetesRadio){
      for (let index = 0; index < this.diabetes.length; index++) {
       ...
       this.diabetes.push(diabetesRadio);
       this.form.diabetes=this.usual.changeString(this.diabetes).family
    },
    // 白天黑夜
    dayornight(val){
      for (let index = 0; index < this.chestPainIncentive.length; index++) {
        if (this.chestPainIncentive[index] == 7) {
          this.chestPainIncentive.splice(index, 1);
        }else if (this.chestPainIncentive[index] == 8) {
          this.chestPainIncentive.splice(index, 1);
        }
      }
      this.chestPainIncentive.push(val)
     this.form.chestPainIncentive=this.usual.changeString(this.chestPainIncentive).family
    },
    // 复选框值变化
    checkboxChange(value, code) {
      ...
      switch (code) {
        case 1:
          _this.form.chestPainSymptom = val.family;
          break;

        case 2:
          _this.form.chestPainIncentive = val.family;
          break;

        case 3:
          _this.form.diabetes = val.family;
          break;
        case 4:
          _this.form.hypertensionComplicated = val.family;
          break;
        case 5:
          _this.form.coronaryHeartComplicated =val.family;
          break;
        case 6:
          _this.form.diabetesComplicated = val.family;
          break;
        case 7:
          _this.form.riskFactor = val.family;
          break;
        case 8:
          _this.form.accomDisease = val.family;
          break;
      }
