        ...
        <el-row>
          <el-col :md="24" :sm="24" :xs="24">
            <el-form-item label="服药情况">
              <div>
                <template>
                  <el-table border :data="form.bsMonthFlupFertinDose" style="width: 100%" :header-cell-style="{background:tableHead}">
...
export default {
  ...
  mounted() {
    this.form.assistantSignatureRul=this.user.name;//assistantSignatureRul
  },
  methods: {
    // 添加单选框字段到复选里
    addToSympom(val) {
