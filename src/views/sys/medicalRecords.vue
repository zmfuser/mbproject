  ...
  <div class="suifang app-container">
    <div class="div-flex">
      <div>
        ...
        <div class="marginTop">
          <label for>状态：</label>
          <el-select v-model="twoName" filterable placeholder="请选择" style="margin-left:28px;">
            <el-option
    ...
    >
      ...
      <el-table-column label="就诊编号" align="center">
        <template slot-scope="scope">
      ...
      <!-- workerTelNo -->
      <el-table-column label="就诊人档案编号" align="center">
        <template slot-scope="scope">
