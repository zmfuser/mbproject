  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <div class="addArticle">
        <el-button plain class="search" @click="addArticle">添加文章</el-button>
      </div>
    </div>
    <br />
    <br />
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300px" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="warning" size="mini" @click="editData(scope.row)">编辑</el-button>
...
export default {
  ...
  methods: {
    ...
    addArticle() {
      let _this = this;
      _this.$router.push("/HealthGuardian/UEditor");
    },
    // 查询
