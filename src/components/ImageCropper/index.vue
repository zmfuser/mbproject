    ...
    <div class="vicp-wrap">
      ...
      <div v-show="step == 1" class="vicp-step1">
        <div class="vicp-drop-area" @dragleave="preventDefault" @dragover="preventDefault" @dragenter="preventDefault" @click="handleClick" @drop="handleChange">
          ...
          <span v-show="loading !== 1" class="vicp-hint">点击或者拖拽文件到这里进行上传</span>
          <span v-show="!isSupported" class="vicp-no-supported-hint">不支持的类型</span>
      ...
      <div v-if="step == 2" class="vicp-step2">
        ...
        <div class="vicp-operate">
          <a @click="setStep(1)" @mousedown="ripple">返回</a>
          <a class="vicp-operate-btn" @click="prepareUpload" @mousedown="ripple">保存</a>
        </div>
      </div>

      <div v-if="step == 3" class="vicp-step3">
        <div class="vicp-upload">
          <span v-show="loading === 1" class="vicp-loading">上传中</span>
          ...
          <div v-show="loading === 2" class="vicp-success">
            <i class="vicp-icon3"/> 成功
          </div>
        </div>
        <div class="vicp-operate">
          <a @click="setStep(2)" @mousedown="ripple">返回</a>
  ...
  methods: {
    ...
    upload() {
      ...
      request({
        url,
        method: 'post',
        data: data2blob(createImgUrl, mime)
      }).then(resData => {
        that.loading = 2
